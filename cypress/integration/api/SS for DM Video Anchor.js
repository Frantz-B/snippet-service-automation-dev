      ...
      cy.fixture('/DM-Creatives-Body/VideoAnchor-Body.json').then((payload) => {
        ...
        cy.fixture('/DM-Creatives-Response/VideoAnchor-Response.json').then((payload2) => {
          ...
          cy.request(snippetServiceRequest).then((snippetServiceResponse) => {
            ...
            assert.include(snippetServiceResponse.body.generated, '"https://tk.kargo.com/t/test.cs-dev.expand');
            assert.include(snippetServiceResponse.body.generated, '"https://tk.kargo.com/t/test.cs-dev.dismiss');
            ...
            assert.include(snippetServiceResponse.body.trackers[12].tid, 'test.cs-dev.expand', 'Trackers object');
            ...
            assert.include(snippetServiceResponse.body.trackers[13].tid, 'test.cs-dev.dismiss', 'Trackers object');
